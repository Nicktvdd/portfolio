...
>
  <div
    class="bg-stone-950 grid place-items-center px-4 text-5xl md:text-6xl -mt-10 sm:-mt-12
  ...
  <div class="flex-1 flex justify-between gap-4 items-center">
    ...
    after:bg-white after:duration-200 hover:after:transtone-x-full after:z-[-1] 
    overflow-hidden"
    >
